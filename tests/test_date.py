...
def test_date_in_entity():
    ...
    class Book(Entity):
        flags = EntityFlags(type_name="book")
...
def test_date_insert_query_formatting():
    ...
    class Product(Entity):
        flags = EntityFlags(type_name="product")
...
def test_date_optional_attribute():
    ...
    class Document(Entity):
        flags = EntityFlags(type_name="document")
...
def test_date_multi_value_attribute():
    ...
    class Timeline(Entity):
        flags = EntityFlags(type_name="timeline")
...
def test_date_boundary_dates():
    ...
    class Record(Entity):
        flags = EntityFlags(type_name="record")
...
def test_date_vs_datetime_distinction():
    ...
    class Event1(Entity):
        flags = EntityFlags(type_name="event1")
        date_only: EventDate

    class Event2(Entity):
        flags = EntityFlags(type_name="event2")
